...
class TestDb(unittest.TestCase):
    ...
    def setUp(self):
        self.save_data = db.save(dict([('task_name', "unittest data"),
    ...
    def test_delete(self):
        ...
        check_delete = (db.Task.select()
                        .where((db.Task.task_name == "unittest data") &
...
class TestFunctions(unittest.TestCase):
    ...
    def test_is_valid_date(self):
        self.assertTrue(functions.is_valid_date(str(datetime.date.today())))
        self.assertFalse(functions.is_valid_date('garbage'))
        self.assertFalse(functions.is_valid_date('0000-00-00'))
        self.assertFalse(functions.is_valid_date('9999-99-99'))
    ...
    def test_url_head_line_to_stdout(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            functions.header_line(test_text)
    ...
    def test_url_display_message_to_stdout(self):
        ...
        expected_out = 'Fred at home\n\n'
        with patch('sys.stdout', new=StringIO()) as fake_out:
            functions.display_message(test_text)
            self.assertIn(expected_out, fake_out.getvalue())
...
class TestTask(unittest.TestCase):
    ...
    def test_edit_task(self):
        data = db.save(dict([('task_name', 'task_name'),
                            ('user_name', 'user_name'),
                            ('minutes', 0),
                            ('notes', 'notes'),
...
class TestLookup(unittest.TestCase):
    ...
    # Lookup by employee, non-existant or data not available
